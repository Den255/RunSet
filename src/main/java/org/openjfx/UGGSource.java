...
public class UGGSource {
    ...
    private static final String PATCH = "12_11";
    private static final String VERSION = "1.5.0";
    private static final String BASE_URL = "https://stats2.u.gg/lol/" + UGG_VERSION + "/table/runes/"+PATCH+"/ranked_solo_5x5/%championId%/"+VERSION+".json";
    public JsonObject getRunes(int championId) {
        ...
        try {
            ...
            //System.out.println(BASE_URL.replace("%championId%", Integer.toString(championId)));
